...
class Agent:
    ...
    def state_get(self, game):
        ...
        state = [
            # Danger straight
            (dir_r and game.is_collide(point_r)) or
            (dir_l and game.is_collide(point_l)) or
            (dir_u and game.is_collide(point_u)) or
            (dir_d and game.is_collide(point_d)),

            # Danger right
            (dir_u and game.is_collide(point_r)) or
            (dir_d and game.is_collide(point_l)) or
            (dir_l and game.is_collide(point_u)) or
            (dir_r and game.is_collide(point_d)),

            # Danger left
            (dir_d and game.is_collide(point_r)) or
            (dir_u and game.is_collide(point_l)) or
            (dir_r and game.is_collide(point_u)) or
            (dir_l and game.is_collide(point_d)),
    ...
    def long_memory_train(self):
        ...
        states, actions, rewards, states_next, dones = zip(*min_sample)
        self.trainer.train_step(states, actions, rewards, states_next, dones)
...
def train():
    ...
    while True:
        ...
        # move perform and get new state
        ...
        if done:
            ...
            scores_total += score
            mean_score = scores_total / agent.no_game
